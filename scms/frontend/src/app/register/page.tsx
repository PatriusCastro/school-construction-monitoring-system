...
export default function RegisterPage() {
  ...
  const getStrength = () => {
    ...
    if (password.length < 6) return { label: 'Too short', color: 'bg-red-400', width: 'w-1/4', text: 'text-red-500' }
    if (password.length < 8) return { label: 'Weak', color: 'bg-orange-400', width: 'w-2/5', text: 'text-orange-500' }
    if (!/[A-Z]/.test(password) || !/[0-9]/.test(password)) return { label: 'Fair', color: 'bg-yellow-400', width: 'w-3/5', text: 'text-yellow-600' }
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Left Panel */}
      <div className="hidden lg:flex w-[42%] bg-[#0d2137] flex-col justify-between p-10">
        ...
        <div className="flex flex-col gap-10">
          <div>
            <h1 className="text-4xl font-bold text-white leading-tight tracking-tight mb-4">
              Join the team<br />building better<br />schools.
            </h1>
      ...
      <div className="flex-1 bg-slate-50 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-[#0d2137] tracking-tight mb-1">Create an account</h2>
